                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="mb-4 flex justify-center items-center gap-3">
                      ...
                      <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-lg px-3 py-2">
                        <svg className="w-5 h-5 fill-white" viewBox="0 0 24 24">
                          <path d="M18.6 0H5.4C2.4 0 0 2.4 0 5.4v13.2C0 21.6 2.4 24 5.4 24h13.2c3 0 5.4-2.4 5.4-5.4V5.4C24 2.4 21.6 0 18.6 0zm-8.5 9.7L7.7 12l2.4 2.3-1 1L6 12l3.1-3.3 1 1zm5.8 5.6L13 12l2.9-3.3 1 1L14.5 12l2.4 2.3-1 1z" />
                        </svg>
